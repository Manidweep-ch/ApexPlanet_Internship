    ...
    <div class="container">
        <div class="card auth-card center">
            ...
            <div class="dashboard-actions">
                ...
                <div><a class="link-button secondary" href="find_users.php">Find Users</a></div>
                <div><a class="link-button success" href="edit_profile.php">Edit Profile</a></div>
                <?php
                // we display the Manage Users button only for admin users
                if($Role === 'admin')
                {
                ?>
                <div><a class="link-button primary" href="manage_users.php">Manage Users</a></div>
                <?php
                }
                ?>
