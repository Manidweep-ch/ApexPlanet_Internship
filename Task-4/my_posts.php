    ...
    <div class="container">
        <div class="center" style="margin-bottom: 20px;">
            ...
            <div class="actions" style="justify-content:center; margin-top:0; margin-bottom:10px;">
                ...
                <a class="link-button primary" href="view_posts.php">View All Posts</a>
        ...
        <div class="pagination center">
            ...
            if($page>1)
                {
                    echo '<a class="link-button secondary" href="?page=' . ($page - 1) . '&search=' . urlencode($search) . '">Previous</a>';
                }
            ?>
            ...
            if($page<$total_pages)
                {
                    ...
                    echo '<a class="link-button secondary" href="?page=' . ($page + 1) . '&search=' . urlencode($search) . '">Next</a>';
                }
            ?>
        </div>
